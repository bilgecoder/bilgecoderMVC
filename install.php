...
<head>
	...
	<title>bilgecoder MVC 1.0</title>
</head>
<body>
	<center>
		<h1>bilgecoderMVC v1.0 kuruluma hoş geldiniz.</h1>.
...
';
			...
			<p>
				<h4>
					Bu MVC Framework Selçuk SAYGILI tarafından kodlanmıştır ve hala geliştirilmeye devam edilmektedir.
					<br />
					Kurulumdan sonra install.php dosyasını siliniz.
					<br />
					İletişim için: <a href="http://www.twitter.com/bilgecoder">buraya </a> tıklayabilirsiniz.
					<br />
					Tarih:09.12.2014
				</h4>
			</p>

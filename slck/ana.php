...
//Selçuk SAYGILI
	class ana{
		...
		/*
			...
			Eklenme şekli: <head><link rel="canonical" href="<?php echo slck::canonical(); ?>" /></head>
		*/
		public function canonical(){
			global $q;
			include "config.php";
			$canonical=$data["site"].implode("/",$q);
			$canonical=slck::bulDegistir("//","/",$canonical);
			return $canonical;
		}
		/*
		...
		/*
			...
			Kullanım şekli:
				...
				eğer sadece bir değişken içinse:
					slck::formVeriDuzelt($degiskeniniz);
